...
//    }
    ...
    public class MyButton {
        ...
        private com.example.vlad.MyButtonClickListener listener;
        private Context context;
        private Resources resources;

        public MyButton(Context context, String text, int textSize, int imageResId, int color, com.example.vlad.MyButtonClickListener listener) {
            this.text = text;
